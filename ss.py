...
def start_screen():
    ...
    rules_button_rect = pygame.Rect(screen_width // 2 - rules_button_width // 2, button_y + 80, rules_button_width, rules_button_height)
    ...
    rules_button_height = 50
    rules_button_rect = pygame.Rect(screen_width - rules_button_width - 10, 10, rules_button_width, rules_button_height)
    ...
    while running:
        ...
        if not show_rules:
            title = font_large.render("SUPER COOL & AWESOME SHOOTER GAME", True, "#ffe7ae")
